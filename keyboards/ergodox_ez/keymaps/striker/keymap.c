...
enum custom_keycodes {
  ...
  KC_COPY_PRIV,  // Copy to the private buffer
  KC_PASTE_PRIV, // Paste from private buffer
  KC_COPY,       // Copy to the public buffer 
  KC_PASTE,      // Paste from the public buffer
  KC_PUSH_DIR,   // pushd
  KC_POP_DIR     // popd
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_GRAVE,       KC_QUOTE,       LALT(KC_LSHIFT),KC_LEFT,        KC_RIGHT,                                                                                                       KC_UP,          KC_DOWN,        KC_LBRACKET,    KC_RBRACKET,    KC_RCTL,
                                                                                                    LALT_T(KC_APPLICATION),KC_TRANSPARENT, KC_LALT,        KC_ESCAPE,
                                                                                                                    MO(5),          MO(4),
                                                                                      MO(3),        KC_LALT,        MO(1),          MO(2),          KC_SPACE,       KC_ENTER
  ),
        //Special
